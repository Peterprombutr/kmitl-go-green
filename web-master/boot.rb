...
AWS_IOT_URL = 'a3f23zc7he5tzr-ats.iot.ap-southeast-1.amazonaws.com' # should be like xxxxx.amazonaws.com
KEY_FILE_NAME = '5be93a5826-private.pem.key' # .key file name under certs folder
CERT_FILE_NAME = '5be93a5826-certificate.pem.crt' # .crt file name under certs folder
CA_FILE_NAME = 'AmazonRootCA1.pem' # .pem file name for rootCA.pem file
...
Dynamoid.configure do |config|
  ...
  config.endpoint = 'https://dynamodb.ap-southeast-1.amazonaws.com/'
end
